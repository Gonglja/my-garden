---
{"dg-publish":true,"permalink":"/🍀 永久笔记/软件技能/windows下使用vscode+mingw完成简单c或 cpp代码的运行与调试/"}
---
...
将在 [[🍀 永久笔记/软件技能/windows下使用vscode+mingw完成简单c或 cpp代码的运行与调试# 下载 mingw 编译链\|# 下载 mingw 编译链]] 下载的编译链解压到路径 xxx 下，记住该路径
